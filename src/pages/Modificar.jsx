            ...
            <div className="flex w-full justify-around items-center justify-center">
              <div className="flex flex-col w-2/4 items-center">
                <label className="relative block my-6 w-96 h-16">
                  ...
                  <input className="placeholder:text-bold placeholder:text-2xl focus:outline-none block font-medium pl-12 pr-3 shadow-sm sm:text-sm bg-stone-200 w-96 h-16" placeholder="NOMBRE" type="text" name="" />
                </label>
                ...
                <label className="relative block my-6 w-96 h-16">
                  ...
                  <input className="placeholder:text-bold placeholder:text-2xl focus:outline-none block font-medium pl-12 pr-3 shadow-sm sm:text-sm bg-stone-200 w-96 h-16" placeholder="QR" type="text" name="" />
                </label>
              </div>
              <div className="flex flex-col w-2/4 items-center">
                <label className="relative block my-6 w-96 h-16">
                  ...
                  <input className="placeholder:text-bold placeholder:text-2xl focus:outline-none block font-medium pl-16 pr-3 shadow-sm sm:text-sm bg-stone-200 w-96 h-16" placeholder="CEDULA" type="number" name="" />
                </label>
                ...
                <label className="relative block my-6 w-96 h-16">
                  ...
                  <input className="placeholder:text-bold placeholder:text-2xl focus:outline-none block font-medium pl-12 pr-3 shadow-sm sm:text-sm bg-stone-200 w-96 h-16" placeholder="FECHA INICIO" type="date" name="Fecha" id="Fecha"/>
                </label>
