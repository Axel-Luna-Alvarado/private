                ...
                <div className="p-16">
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <label className="relative block mt-4 w-80">
                            ...
                            <input type="text" {...register('Cedula')} placeholder="Cedula" required className="placeholder:text-bold block py-2 pl-9 pr-3 shadow-sm sm:text-sm bg-stone-200 w-80" />
                        </label>
                        <label className="relative block mt-4 w-80">
                            <span className="absolute inset-y-0 left-0 flex items-center pl-2">
                                <MdEmail />
